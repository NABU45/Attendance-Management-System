  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="component1 course-card  rounded-2xl w-72 ">
      ...
      <div className="mb-8">
              <div className="relative">
                <div className="radial-progress bg-accent text-lg text-accent-content text-white rounded-full px-10 py-10  " style={{ size: 7, value: 70 }}>70%</div>
...
export default CourseComponent1;
