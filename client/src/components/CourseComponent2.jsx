  ...
  return (
    <div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="component2 course-card rounded-2xl w-72 ">
      ...
      <div className="mb-8">
              <div className="relative">
                <div className="radial-progress bg-accent text-lg text-accent-content text-white rounded-full px-10 py-10  " style={{ size: 7, value: 70 }}>60%</div>
                <div className="absolute inset-0 rounded-full border-gradient "></div>
              </div>
            </div>
            <div className="text-center">
              <p className="text-xl text-white font-bold mb-2">MERN</p>
...
export default CourseComponent2
