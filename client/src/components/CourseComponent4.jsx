    ...
    <div>
      ...
      <div className="mb-8">
              <div className="relative">
                <div className="radial-progress bg-accent text-lg text-accent-content text-white rounded-full px-10 py-10  " style={{ size: 7, value: 70 }}>50%</div>
                <div className="absolute inset-0 rounded-full border-gradient "></div>
              </div>
            </div>
            <div className="text-center">
              <p className="text-xl text-white font-bold mb-2">Ui/Ux design</p>
...
export default CourseComponent4;
