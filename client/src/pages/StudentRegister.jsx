...
import StudenetDetails from '../components/StudenetDetails';
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
            ...
            <body className="antialiased font-sans bg-gray-200">
                <div className="w-[100%]  mx-auto bg-white rounded shadow">
                    ...
                    <div className="mx-16 py-4 px-1 text-black text-2xl font-bold ">Student Registeration</div>
                ...
                <div className="container mx-auto px-4 sm:px-8">
                    <div className="py-8">
                        ...
                        <div className='border-gray-200  bg-white '> 
                            ...
                            <p>Student Id</p>
                            <p className='-ml-4'>StudentId Name</p>
                            <p className='mr-14'>Course</p>
